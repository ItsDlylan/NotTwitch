...
exports.protect = catchAsync(async (req, res, next) => {
	...
	// GRANT ACCESS TO PROTECTED ROUTE and set the req.user equal to the user for further controlling.
...
exports.restrictTo = (...roles) => {
	return (req, res, next) => {
		...
		//if user is an admin then go to the next middleware
		next();
	};
};
...
exports.forgotPassword = catchAsync(async (req, res, next) => {
	...
	// Because createPasswordResetToken updates the document, we have to then save the new document.
	...
	const message = `Forgot your password? Submit a PATCH request with your new password and passwordConfirm to: ${resetURL}.\n If you didn't forget your password, and request for a reset, we recommend updating your password! `;
...
exports.resetPassword = catchAsync(async (req, res, next) => {
	...
	// If no token or token is expired, throw error.
	if (!user) {
	...
	// this was done on the userModel with a presave method.
